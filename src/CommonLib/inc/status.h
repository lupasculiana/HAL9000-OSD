...
#define CL_STATUS_TRUNCATED_PROCESS_NAME                   (ERROR_MASK | CUSTOMER_BIT | GENERAL_MASK | 0x0036UL)
...
#define STATUS_TRUNCATED_PROCESS_NAME                   CL_STATUS_TRUNCATED_PROCESS_NAME
